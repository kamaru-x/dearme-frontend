                ...
                <div className="mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center p-6 hover:bg-gray-50 transition-all duration-200 ease-in-out rounded-xl border-2 border-dashed border-blue-300 bg-white shadow-md hover:shadow-lg group text-left w-full"
                        >
                            <div className="flex-shrink-0 w-16 h-16 mr-6 bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg flex flex-col items-center justify-center">
                                <span className="text-2xl font-bold text-blue-600">{today.day}</span>
                                <span className="text-xs font-medium text-blue-500">{today.month}</span>
                            </div>
                            <div className="min-w-0 flex items-center">
                                <div>
                                    <h3 className="text-xl font-semibold text-blue-600 group-hover:text-blue-700 transition-colors duration-200">
                        ...
                        {journals.map((journal) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="flex items-center p-6 hover:bg-gray-50 transition-all duration-200 ease-in-out rounded-xl border border-gray-100 bg-white shadow-md hover:shadow-lg group text-left w-full"
                                >
                                    <div className="flex-shrink-0 w-16 h-16 mr-6 bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg flex flex-col items-center justify-center">
                                        <span className="text-2xl font-bold text-blue-600">{date.day}</span>
                                        <span className="text-xs font-medium text-blue-500">{date.month}</span>
                                    </div>
