                ...
                <div className="mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 ease-in-out rounded-xl border-2 border-dashed border-blue-300 dark:border-blue-500/50 bg-white dark:bg-gray-800 shadow-md hover:shadow-lg group text-left w-full"
                        >
                        ...
                        {journals.map((journal) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="flex items-center p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 ease-in-out rounded-xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-md hover:shadow-lg group text-left w-full"
                                >
                                    <div className="flex-shrink-0 w-16 h-16 mr-6 bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/50 dark:to-blue-800/50 rounded-lg flex flex-col items-center justify-center">
